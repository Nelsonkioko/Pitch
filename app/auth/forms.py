...
class RegistrationForm(FlaskForm):
    ...
    email = StringField('Please enter your your email address',validators=[Required(),Email()])
    username = StringField('Please enter your your username',validators=[Required()])
...
#login class  takes three inputs from the user and has one boolean
